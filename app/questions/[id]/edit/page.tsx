  ...
  React.useEffect(() => {
    if (question) {
      setFormData({
        ...
        allow_negative_marking: question.allow_negative_marking,
      });
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Edit options and select the correct answer. Click on an option
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Edit tags to help categorize and search for this question
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
